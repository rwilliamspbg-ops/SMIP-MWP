...
SMIP-MWP is a high-performance sovereign transport/routing stack focused on:
...
- AF_XDP prerequisites and runbook hardening
...
- Executive roadmap: [ROADMAP_EXECUTIVE_SUMMARY.md](ROADMAP_EXECUTIVE_SUMMARY.md)
- Live timeline tracker: [TIMELINE_AND_TRACKER.md](TIMELINE_AND_TRACKER.md)
- Implementation plan: [IMPLEMENTATION_PLAN.md](IMPLEMENTATION_PLAN.md)
- Benchmark policy and interpretation: [benchmarks/README.md](benchmarks/README.md)
